        ...
        <div className="w-full h-full flex flex-col bg-[#121212] animate-slide-up">
          <div className="flex-1 overflow-auto pb-28">
            ...
            <div className="w-full bg-[#202020] relative">
              {/* Botón de regreso flotante fijo, independiente del scroll */}
              <button 
                onClick={onClose}
                className="fixed top-4 left-4 z-50 bg-[#252525]/80 p-2 rounded-full text-white/90 hover:bg-[#333] transition-colors shadow-lg backdrop-blur-sm"
              >
                <ArrowLeft size={20} />
              </button>
