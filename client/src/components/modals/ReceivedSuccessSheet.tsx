    ...
    <Sheet open={isOpen} onOpenChange={handleClose}>
      ...
      >
        ...
        <div className="p-6 text-center">
          ...
          <button 
            onClick={handleClose}
            className="w-full px-4 py-3 bg-primary hover:bg-primary/90 text-white rounded-lg text-base font-medium transition-colors flex items-center justify-center mt-6"
          >
            Cerrar
          </button>
        </div>
