      ...
      >
        ...
        <div className="p-6 text-center">
          ...
          <button 
            onClick={handleClose}
            disabled={refreshing}
            className="w-full px-4 py-3 bg-primary hover:bg-primary/90 text-black rounded-lg text-base font-medium transition-colors flex items-center justify-center mt-8 relative"
          >
            {refreshing ? (
              <>
