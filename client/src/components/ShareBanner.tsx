    ...
    <div className="bg-gradient-to-r from-primary/80 to-primary rounded-xl p-5 mt-6 shadow-lg">
      <div className="flex items-center justify-between">
        ...
        <button 
          ...
          className="bg-white/20 hover:bg-white/30 text-white p-2.5 rounded-lg font-medium shadow-md transition-all duration-300 hover:shadow-lg border border-white/10 flex items-center justify-center"
