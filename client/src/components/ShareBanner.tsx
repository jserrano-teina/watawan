    ...
    <div className="bg-gradient-to-r from-primary/30 to-primary/50 rounded-xl p-5 mt-6 shadow-lg border border-primary/30">
      <div className="flex items-center justify-between">
        ...
        <button 
          ...
          className="bg-primary/50 hover:bg-primary/60 text-white p-2.5 rounded-lg font-medium shadow-sm transition-all duration-300 hover:shadow-md border border-primary/40 flex items-center justify-center"
